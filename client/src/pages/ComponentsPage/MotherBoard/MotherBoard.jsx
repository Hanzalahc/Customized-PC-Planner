...
function MotherBoard() {
  ...
  const showAllMotherboard = async (page) => {
    const payload = {
      pageNum: page,
    };
    ...
    const response = await apiSubmit({
      url: apis().getAllMotherboard.url,
      method: apis().getAllMotherboard.method,
      query: { data: payload },
      successMessage: null,
    ...
    if (response?.success) {
      setMotherboardData(response?.data.motherboards);
      setPaginations({
  ...
  useEffect(() => {
    showAllMotherboard(paginations.productCurrentPage);
  }, [
      ...
      <Container className={"w-full my-[3rem]"}>
        <div className="mx-auto max-w-7xl px-2 py-10 lg:px-10">
          <div className="md:flex md:flex-row md:items-start md:justify-between">
            <div>
              <h1 className="h1">Motherboard Products</h1>
            </div>
          </div>
          <hr className="my-8" />
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-6">
            ...
            <div className="h-[400px] w-full rounded-lg px-2 lg:col-span-9 lg:h-full">
              ...
              <div className="item-box grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {motherboardData && motherboardData.length > 0 ? (
                  ...
                  <div>No Motherboard to show</div>
                )}
              </div>
