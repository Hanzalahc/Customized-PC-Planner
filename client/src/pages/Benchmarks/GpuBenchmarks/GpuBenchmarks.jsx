  ...
  return (
    <span className="mb-4 block">
      <input
        ...
        placeholder="Search GPU benchmarks..."
        className="px-4 py-2 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-400"
      />
    </span>
  );
}
...
function GpuBenchmarks() {
  ...
  const data = useMemo(() => gpuData, [gpuData]);
                ...
                >
                  {headerGroup.headers.map((column) => (
                    <th
                      ...
                      key={column.id} // Ensure unique key
                    >
