...
const CaseEditForm = () => {
  ...
  const handleFormSubmit = async (data) => {
    ...
    const formattedData = {
      ...
      videoCardLength: data?.videoCardLength,
  ...
  const fetchProductData = async () => {
    ...
    if (response?.success) {
      ...
      setValue(
        "sidePanel",
        response.data.sidePanel
          ? { value: response.data.sidePanel, label: response.data.sidePanel }
          : null
      );

      setValue(
        "frontPanel",
        response.data.frontPanel
          ? { value: response.data.frontPanel, label: response.data.frontPanel }
          : null
      );

      setValue(
        "formFactor",
        response.data.formFactor
          ? { value: response.data.formFactor, label: response.data.formFactor }
          : null
      );
